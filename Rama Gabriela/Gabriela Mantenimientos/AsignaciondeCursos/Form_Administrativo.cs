...
namespace AsignaciondeCursos
{
    public partial class Form_Administrativo : Form
    {
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (this.spc_principal.Panel2.Controls.Count > 0)
                this.spc_principal.Panel2.Controls.RemoveAt(0);
            form_IngresarEstudiante f = new form_IngresarEstudiante();
            f.TopLevel = false;
            f.FormBorderStyle = FormBorderStyle.None;
            f.Dock = DockStyle.Fill;
            this.spc_principal.Panel2.Controls.Add(f);
        ...
        private void llbl_ingresarcatedratico_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (this.spc_principal.Panel2.Controls.Count > 0)
                this.spc_principal.Panel2.Controls.RemoveAt(0);
            Form_AgregarCatedratico f = new Form_AgregarCatedratico ();
            f.TopLevel = false;
            f.FormBorderStyle = FormBorderStyle.None;
            f.Dock = DockStyle.Fill;
            this.spc_principal.Panel2.Controls.Add(f);
        ...
        private void llbl_ingresarcurso_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (this.spc_principal.Panel2.Controls.Count > 0)
                this.spc_principal.Panel2.Controls.RemoveAt(0);
            form_IngresoCurso f = new form_IngresoCurso ();
            f.TopLevel = false;
            f.FormBorderStyle = FormBorderStyle.None;
            f.Dock = DockStyle.Fill;
            this.spc_principal.Panel2.Controls.Add(f);
        ...
        private void llbl_carrfacupensum_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
                if (this.spc_principal.Panel2.Controls.Count > 0)
                this.spc_principal.Panel2.Controls.RemoveAt(0);
              Mantenimiento_facultad f = new Mantenimiento_facultad();
        ...
        private void llbl_salon_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (this.spc_principal.Panel2.Controls.Count > 0)
                this.spc_principal.Panel2.Controls.RemoveAt(0);
            form_EdificioSalon f = new form_EdificioSalon();
            f.TopLevel = false;
            f.FormBorderStyle = FormBorderStyle.None;
            f.Dock = DockStyle.Fill;
            this.spc_principal.Panel2.Controls.Add(f);
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (this.spc_principal.Panel2.Controls.Count > 0)
                this.spc_principal.Panel2.Controls.RemoveAt(0);
           Mantenimiento_carrera f = new Mantenimiento_carrera();
            f.TopLevel = false;
            f.FormBorderStyle = FormBorderStyle.None;
            f.Dock = DockStyle.Fill;
            this.spc_principal.Panel2.Controls.Add(f);
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (this.spc_principal.Panel2.Controls.Count > 0)
                this.spc_principal.Panel2.Controls.RemoveAt(0);
            Mantenimiento_pensum f = new Mantenimiento_pensum();
            f.TopLevel = false;
            f.FormBorderStyle = FormBorderStyle.None;
            f.Dock = DockStyle.Fill;
            this.spc_principal.Panel2.Controls.Add(f);
