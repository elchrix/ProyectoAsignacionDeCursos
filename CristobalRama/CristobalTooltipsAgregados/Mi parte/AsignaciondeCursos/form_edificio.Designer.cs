namespace AsignaciondeCursos
{
    partial class form_edificio
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.dgv_edificio, "Aqui se les mostrara los datos que se encuentran en la base de datos");
            // 
            ...
            this.toolTip1.SetToolTip(this.Btn_modificaredifici, "Al dar clic en este boton, seguido se mostrara el formulario de modificacion");
            ...
            this.toolTip1.SetToolTip(this.Btn_ingresaredificio, "Al dar clic en este boton se ingresaran los datos de edificio a la base de datos");
            ...
            this.toolTip1.SetToolTip(this.Btn_elimnar, "Seleccione la fila que desee eliminar, luege dar clic");
