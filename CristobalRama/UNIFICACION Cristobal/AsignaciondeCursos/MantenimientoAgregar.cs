...
namespace AsignaciondeCursos
{
    class MantenimientoAgregar
    {
        ...
        public static int agregarcurso(String id_carrera, string cod_curso, string numero_sab, string numero, string numero_ciclo, string numero_creditos ,string laboratorio, string prerrequisitos , string creditos_necesarios , string nombre_curso, string aniopensum)
        {
            MySqlConnection con = Conexion.ObtenerConexion();
            int devolver = 0;
