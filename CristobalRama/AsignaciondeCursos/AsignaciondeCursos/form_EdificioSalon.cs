...
namespace AsignaciondeCursos
{
    public partial class form_EdificioSalon : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int resultado = MantenimientoAgregar.agregarsalon(txt_no_salon.Text, cbo_edificio.SelectedItem.ToString(), txt_tamanio.Text ,txt_cant.Text,cboestatus.SelectedItem.ToString());
            if (resultado > 0)
            {
        ...
        private void txt_idedificio_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txt_pisos_KeyPress(object sender, KeyPressEventArgs e)
        {
