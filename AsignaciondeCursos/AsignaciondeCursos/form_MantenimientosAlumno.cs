    ...
    public partial class form_MantenimientosAlumno : Form
    {
        ...
        private void form_MantenimientosAlumno_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt2 = MantenimientosManejo.CargarGrid("select id_carrera, año_ingreso, no_carne, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, correo_electronico, direccion, anio_pensum from Alumno");
        ...
        private void btn_eliminarA_Click(object sender, EventArgs e)
        {
            ...
            if (resultado == DialogResult.OK)
            {
                try
                {
                    String sQuery = "delete from Alumno where id_carrera='" + id_carrera + "' and año_ingreso = '" + año_ingreso + "' and no_carne = '" + no_carne + "'";
                    MySqlCommand comando = new MySqlCommand(sQuery, con);
                    MySqlDataAdapter adaptador = new MySqlDataAdapter(comando);
        ...
        {
            DataTable dt = MantenimientosManejo.CargarGrid("select id_carrera, año_ingreso, no_carne, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, correo_electronico, direccion, anio_pensum from Alumno");
